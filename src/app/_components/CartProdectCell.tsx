...
import imf from "@/images/19b048dcec278f9d9c89514b670e0d9f8909f6dc.png"
...
export default function CartProdectCell() {
    ...
    const { totalCartPrice, prodect, NavCartNo, setProdects, settotalCartPrice, setNavCartNo } = useContext(finalContext)
